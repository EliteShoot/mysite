...
to = "info@infinitilendinggroup.com";
//Put in your email address hear
subject = "Free Quote Request - Infiniti Lending Group";
// The default subject.will appear by default in all message. change this if you want.
//User Info (DO NOT EDIT).
loanamount = stripcslashes(_POST['loanamount']);
// User's Loan Amount
income = stripcslashes(_POST['income']);
// User's Income
purposeloan = stripcslashes(_POST['purposeloan']);
//User's purpose of loan
loanyears = stripcslashes(_POST['loanyears']);
// Loan Years
yourname = stripcslashes(_POST['yourname']);
//User's Name
email = stripcslashes(_POST['your-email']);
//User's Email
phone = stripcslashes(_POST['phonenumber']);
//User's Mobile Number
maritalstatus = stripcslashes(_POST['maritalstatus']);
//User's Martial Status
birthdate = stripcslashes(_POST['birthdate']);
//User's Birth Date
taxpayer = stripcslashes(_POST['taxpayer']);
//User's Taxtpayer Id
address = stripcslashes(_POST['address']);
//User's Address
employer_status = stripcslashes(_POST['employer_status']);
//User's Employer Status
msg = "";
...
if (mail) {
    ...
    //This is the message that will be shown when an error occured: the message was not send
}