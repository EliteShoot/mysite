...
define( "RECIPIENT_NAME", "Infiniti Lending Group" );
define( "RECIPIENT_EMAIL", "info@infinitilendinggroup.com" );
...
$mail_subject = 'Infiniti Lending Inquiry by ' . $name;
...
if ( $name && $senderEmail && $message ) {
  ...
  echo "<div class='inner success'><p class='success'>Thanks for contacting us. We will get back to you as soon as possible!</p></div><!-- /.inner -->";
}else {
