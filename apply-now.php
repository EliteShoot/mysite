<?php 
$to = "info@infinitilendinggroup.com";	//Put in your email address hear
$subject  = "Free Quote Request - Infiniti Lending Group"; // The default subject.will appear by default in all message. change this if you want.
